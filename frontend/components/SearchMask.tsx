                ...
                {isCompact ? (
                    ...
                    <div className="flex items-center w-full h-full">
                        ...
                        <div className="flex items-center gap-3 px-4 py-2 flex-1 min-w-0 cursor-pointer hover:bg-slate-50 transition-colors rounded-full">
                            <div className="w-8 h-8 rounded-full bg-rose-50 flex items-center justify-center text-black text-xs shrink-0">
                        ...
                        <div className="ml-2 w-10 h-10 bg-[#000000] rounded-full flex items-center justify-center text-white shadow-md hover:scale-105 transition-transform shrink-0">
                    ...
                    <>
                        <div className="flex items-center gap-4 py-2 pr-8 border-r border-slate-100">
                            <div className="w-10 h-10 rounded-full bg-rose-50 flex items-center justify-center text-black">
                                <i className="fa-solid fa-location-dot text-sm"></i>
                            </div>
                            <div className="flex flex-col text-left">
                                <span className="text-[11px] font-black uppercase tracking-widest text-slate-800 group-hover:text-black transition-colors">Wohin?</span>
                        ...
                        <div className="flex items-center gap-4 px-8 border-r border-slate-100 hidden md:flex">
                            ...
                            <div className="flex flex-col text-left">
                                <span className="text-[11px] font-black uppercase tracking-widest text-slate-800 group-hover:text-black transition-colors">Wann?</span>
                        ...
                        <div className="flex items-center gap-4 px-8 hidden md:flex">
                            ...
                            <div className="flex flex-col text-left">
                                <span className="text-[11px] font-black uppercase tracking-widest text-slate-800 group-hover:text-black transition-colors">Wer?</span>
                                <span className="text-slate-400 font-medium">{guests} Gäste</span>
                            </div>
                        </div>
                        <div className="w-12 h-12 bg-[#000000] rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
                            ...
                            >
                                ...
                                <div className="px-8 py-6 flex items-center justify-between shrink-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 bg-[#000000] rounded-lg flex items-center justify-center text-white">
                                    ...
                                    <div className="flex items-center gap-12">
                                        <button onClick={() => setCurrentStep(1)} className={`flex items-center gap-3 transition-colors ${currentStep === 1 ? 'opacity-100' : 'opacity-40 hover:opacity-100'}`}>
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${currentStep === 1 ? 'bg-[#000000] text-white' : 'bg-slate-100 text-slate-500'}`}>1</div>
                                        ...
                                        <button onClick={() => setCurrentStep(2)} className={`flex items-center gap-3 transition-colors ${currentStep === 2 ? 'opacity-100' : 'opacity-40 hover:opacity-100'}`}>
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${currentStep === 2 ? 'bg-[#000000] text-white' : 'bg-slate-100 text-slate-500'}`}>2</div>
                                        ...
                                        <button onClick={() => setCurrentStep(3)} className={`flex items-center gap-3 transition-colors ${currentStep === 3 ? 'opacity-100' : 'opacity-40 hover:opacity-100'}`}>
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${currentStep === 3 ? 'bg-[#000000] text-white' : 'bg-slate-100 text-slate-500'}`}>3</div>
                                        ...
                                        <div className="w-full max-w-4xl px-4 text-center animate-in slide-in-from-bottom-8 duration-500">
                                            ...
                                            <div className="relative max-w-2xl mx-auto mb-16 group">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full h-20 pl-16 pr-6 rounded-full border-2 border-rose-100 bg-white shadow-[0_8px_30px_rgb(255,56,92,0.06)] text-lg font-bold text-slate-900 focus:outline-none focus:border-[#000000] focus:ring-4 focus:ring-[#000000]/10 placeholder:text-slate-300 transition-all font-jakarta"
                                                    value={location}
                                            ...
                                            <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-12 items-start justify-center">
                                                ...
                                                <div className="flex flex-col gap-4 lg:gap-6 w-full lg:w-96">
                                                    <button
                                                        ...
                                                        className="w-full p-6 lg:p-8 bg-white border border-slate-100 rounded-[2rem] lg:rounded-[2.5rem] flex items-center gap-6 hover:border-[#000000] transition-all group text-left shadow-sm order-2 lg:order-1"
                                                    >
                                                        <div className="w-12 h-12 bg-rose-50 rounded-xl flex items-center justify-center text-black group-hover:bg-black group-hover:text-white transition-colors shrink-0">
